...
def transformData(trainDF, testDF):
    predictors = ['1stFlrSF', '2ndFlrSF', 'LotFrontage']
    '''
    ...
    '''
    trainDF.loc[:, "LotFrontage"] = trainDF.loc[:, "LotFrontage"].fillna(trainDF.loc[:, "LotFrontage"].median())
    testDF.loc[:, "LotFrontage"] = testDF.loc[:, "LotFrontage"].fillna(trainDF.loc[:, "LotFrontage"].median())
